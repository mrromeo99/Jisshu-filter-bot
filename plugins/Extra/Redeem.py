...
<b>Jᴜsᴛ ᴄʟɪᴄᴋ ᴏɴᴇ ᴏғ ᴛʜᴇ ᴀʙᴏᴠᴇ ᴄᴏᴅᴇ ᴛᴏ ᴄᴏᴘʏ ᴀɴᴅ sᴇɴᴅ ɪᴛ ᴛᴏ ᴛʜᴇ ʙᴏᴛ, ᴛʜᴀᴛ's ɪᴛ 🔥</b>"""

        keyboard = InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("♻️ ʀᴇᴅᴇᴇᴍ ʜᴇʀᴇ ♻️", url="http://t.me/Tmfltbot")],
                [InlineKeyboardButton("❕ ᴀɴʏ ǫᴜᴇʀʏ ❕", url="https://t.me/pArAd0X6")]
            ]
        )
